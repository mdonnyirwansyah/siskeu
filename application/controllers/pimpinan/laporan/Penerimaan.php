...
class Penerimaan extends Pimpinan_Controller {
    ...
    {
        $this->vars['user']     = user();
        $this->vars['judul']    = 'Laporan Penerimaan';
        $this->vars['tahun']    = $this->Penerimaan_m->get_tahun();
        $this->vars['bulan']    = $this->Penerimaan_m->get_bulan();
        $this->load->view('pimpinan/laporan/penerimaan/index', $this->vars);
    }
    ...
    public function form_view()
    {
        if ($this->input->is_ajax_request() == true) {
            ...
            $msg = [
                    'sukses' => $this->load->view('pimpinan/modal/view-penerimaan', $data, true)
            ];
