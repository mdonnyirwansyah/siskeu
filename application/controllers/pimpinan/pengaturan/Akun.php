...
class Akun extends Pimpinan_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('pimpinan/pengaturan/akun/index', $this->vars);
    }
    ...
    {
        if ($this->input->is_ajax_request() == true) {
            $this->vars['user'] = $this->db->get_where('tb_user', ['email' => $this->session->userdata('email')])->row_array();
