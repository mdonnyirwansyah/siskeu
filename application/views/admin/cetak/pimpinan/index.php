	...
	<table style="margin:auto;" class="bordered">
		<tr class="bordered">
			...
			<td class="bordered" style="font-size:16pt;">
				<center><strong>
					LAPORAN PENGELUARAN PIMPINAN<br>
	...
	<table style="width:100%;margin: auto;" class="border">
		<thead style="font-size:12pt; background-color: #A9A9A9;">
		  <tr>
			...
			<th class="border" style="text-align: center; width: 10%; margin-right: 1em">Tanggal</th>
			<th class="border" style="text-align: center;width: 10%">Uraian</th>
			<th class="border" style="text-align: center;width: 10%">Penerima</th>
			<th class="border" style="text-align: center;width: 20%">Kebutuhan</th>
			<th class="border" style="text-align: center;width: 10%">Satuan</th>
			<th class="border" style="text-align: center;width: 5%">Vol</th>
			<th class="border" style="text-align: center; width: 15%">Jumlah</th>
			<th class="border" style="text-align: center; width: 15%">Keterangan</th>
		  </tr>
		</thead>
		<tbody style="font-size:10pt;">
		  <?php $i = 1; foreach ($pimpinan as $row) : ?>
		  <tr>
			...
			<td class="border"><?= $row->kebutuhan ?></td>
			<td class="border">Rp <?= number_format($row->satuan,0,',','.') ?>,-</td>
			<td class="border"><?= $row->volume ?></td>
			<td class="border">Rp <?= number_format($row->jumlah,0,',','.') ?>,-</td>
		...
		<tfoot>
          <tr>
            <th class="border" colspan="7" style="text-align: center; height: 2em">Total</th>
