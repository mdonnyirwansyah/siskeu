...
<body>
        ...
        <section class="section">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <hr>
                    <?= form_open_multipart('admin/data/penerimaan/tambah', ['class' => 'formtambah']) ?>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <hr>
                <form action="<?= base_url('admin/data/penerimaan/cetak') ?>" method="post" target="_blank">
                  <div class="row">
                    <div class="col-md-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <a style="min-width: 100px;" href="#tb_penerimaan" id="search" class="btn btn-success mr-1"><i class="fas fa-sync-alt"> Proses</i></a> 
                        <button type="submit" style="min-width: 100px;" class="btn btn-primary mr-1"><i class="fa fa-print"></i> Cetak</button>
                        <a style="min-width: 100px;" href="#tb_penerimaan" id="reset" class="btn btn-danger"><i class="fas fa-power-off"> Reset</i></a>
                      </div>
                    </div>
                  </div>
                <?= form_close(); ?>
	          ...
	          <div class="row">
	            <div class="col-md-12">
                    ...
                    <div>
                      ...
                      <hr>
          	 				  <table id="tb_penerimaan" class="table table-striped display nowrap" style="width:100%">
            						<thead>
            						  <tr>
  ...
  function tampil_data(tahun1='', bulanawal='', bulanakhir='') {
    $('#tb_penerimaan').DataTable({
          ...
          "ajax": {
              "url": "<?= site_url('admin/data/penerimaan/get_tabel'); ?>",
              "type": "POST",
              "data":{
                  tahun1 : tahun1, 
                  bulanawal : bulanawal, 
  ...
  function sum(tahun1='', bulanawal='', bulanakhir=''){
    $.ajax({
        type  : 'POST',
        url   : '<?= site_url()?>admin/data/penerimaan/get_sum',
          data:{
                    tahun1 : tahun1, 
                    bulanawal : bulanawal, 
                    bulanakhir : bulanakhir
    ...
    sum();
      ...
      $('#search').click(function(){
        ...
        if(bulanawal != 'Pilih bulan' && bulanakhir != 'Pilih bulan' && tahun1 != 'Pilih tahun' && bulanawal <= bulanakhir){
            $('#tb_penerimaan').DataTable().destroy();
  ...
  function impor(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('admin/data/penerimaan/form_impor'); ?>",
      data: {
          id: id
      },
      dataType: "json",
  ...
  function view(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('admin/data/penerimaan/form_view'); ?>",
      data: {
          id: id
      },
      dataType: "json",
  ...
  function edit(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('admin/data/penerimaan/form_edit'); ?>",
      data: {
          id: id
      },
      dataType: "json",
  ...
  function hapus(id) {
    Swal.fire({
            ...
            if (result.value) {
              $.ajax({
                type: "post",
                url: "<?= site_url('admin/data/penerimaan/hapus'); ?>",
                data: {
                  id : id
                },
                dataType: "json",
