...
<body>
        ...
        <section class="section">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <hr>
                    <?= form_open_multipart('admin/data/pengeluaran/tambah', ['class' => 'formtambah']) ?>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <hr>
                <form action="<?= base_url('admin/data/pengeluaran/cetak') ?>" method="post" target="_blank">
                  <div class="row">
                    <div class="col-md-3">
  ...
  function tampil_data(tahun1='', bulanawal='', bulanakhir='') {
    $('#tb_pengeluaran').DataTable({
          ...
          "ajax": {
              "url": "<?= site_url('admin/data/pengeluaran/get_tabel'); ?>",
              "type": "POST",
              "data":{
                  tahun1 : tahun1, 
                  bulanawal : bulanawal, 
  ...
  function sum(tahun1='', bulanawal='', bulanakhir=''){
    $.ajax({
        type  : 'POST',
        url   : '<?= site_url()?>admin/data/pengeluaran/get_sum',
          data:{
                    tahun1 : tahun1, 
                    bulanawal : bulanawal, 
                    bulanakhir : bulanakhir
  ...
  function impor(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('admin/data/pengeluaran/form_impor'); ?>",
      data: {
          id: id
      },
      dataType: "json",
  ...
  function view(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('admin/data/pengeluaran/form_view'); ?>",
      data: {
          id: id
      },
      dataType: "json",
  ...
  function edit(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('admin/data/pengeluaran/form_edit'); ?>",
      data: {
          id: id
      },
      dataType: "json",
  ...
  function hapus(id) {
    Swal.fire({
            ...
            if (result.value) {
              $.ajax({
                type: "post",
                url: "<?= site_url('admin/data/pengeluaran/hapus'); ?>",
                data: {
                  id : id
                },
                dataType: "json",
