	    <!-- Modal impor Pengeluaran -->
      <div class="modal fade" id="impor" tabindex="-1" aria-labelledby="imporLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <strong style="font-size: 18px; color: black" class="modal-title" id="imporLabel">Impor Pengeluaran</strong>
              <button type="button" class="close close-a" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
          <?= form_open_multipart('admin/data/pengeluaran/impor', ['class' => 'formimpor']) ?>
