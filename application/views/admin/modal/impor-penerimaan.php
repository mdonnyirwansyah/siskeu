	    <!-- Modal impor Penerimaan -->
      <div class="modal fade" id="impor" tabindex="-1" aria-labelledby="imporLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <strong style="font-size: 18px; color: black" class="modal-title" id="imporLabel">Impor Penerimaan</strong>
              <button type="button" class="close close-a" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
          <?= form_open_multipart('admin/data/penerimaan/impor', ['class' => 'formimpor']) ?>
          <div class="modal-body">
            <div class="form-group">
              <div class="pesan_impor" style="display: none;"></div>
            </div>
            <div class="row">
              <div class="col-md-3">
          ...
          <div class="modal-footer">
            ...
            <button style="min-width: 100px;" type="button" class="btn btn-danger close-a" data-dismiss="modal"><i class="fas fa-times-circle"></i> Keluar</button>
          </div>
          <?= form_close(); ?>
        </div>
      </div>
    </div>
    <!-- Modal impor Penerimaan Ends -->
          ...
          $('.close-a').addClass('menyembunyikan');
            ...
            processData: false,
	          ...
	          success: function(response) {
	            if (response.error) {
	              $('.pesan_impor').html(response.error).show();
