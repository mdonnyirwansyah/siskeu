	    <!-- Modal view Pengeluaran Pimpinan -->
      <div class="modal fade" id="view" tabindex="-1" aria-labelledby="viewLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <strong style="font-size: 18px; color: black" class="modal-title" id="viewLabel">Detail Pengeluaran Pimpinan</strong>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="form-group">
                  <input type="text" class="form-control" name="penerima" id="penerima" value="<?= $penerima ?>" readonly>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="form-group">
                  <textarea class="form-control" name="kebutuhan" id="kebutuhan" readonly><?= $kebutuhan ?></textarea>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="form-group">
                  <input type="text" class="form-control" name="satuan" id="satuan" value="Rp <?= number_format($satuan,0,',','.'); ?>,-" readonly>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="form-group">
                  <input type="text" class="form-control" name="volume" id="volume" value="<?= $volume ?>" readonly>
                </div>
              </div>
            </div>
            <div class="row">
    ...
    <!-- Modal view Pengeluaran Pimpinan Ends -->
