...
<body>
  ...
  function tampil_data(tahun1='', bulanawal='', bulanakhir='') {
    $('#tb_pengeluaran').DataTable({
          ...
          "ajax": {
              "url": "<?= site_url('pimpinan/laporan/pengeluaran/get_tabel'); ?>",
              "type": "POST",
              "data":{
                  tahun1 : tahun1, 
                  bulanawal : bulanawal, 
  ...
  function sum(tahun1='', bulanawal='', bulanakhir=''){
    $.ajax({
        type  : 'POST',
        url   : '<?= site_url()?>pimpinan/laporan/pengeluaran/get_sum',
          data:{
                    tahun1 : tahun1, 
                    bulanawal : bulanawal, 
                    bulanakhir : bulanakhir
  ...
  function view(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('pimpinan/laporan/pengeluaran/form_view'); ?>",
      data: {
          id: id
      },
      dataType: "json",
