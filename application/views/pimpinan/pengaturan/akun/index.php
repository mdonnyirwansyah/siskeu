...
<body>
            ...
            <div class="section-body">
              <div class="row">
                <div class="col-12 col-md-12">
                  <div class="card profile-widget">
                    <div class="profile-widget-header">
                      ...
                      <div class="profile-widget-items">
                        ...
                        <div class="profile-widget-item">
                          <div class="profile-widget-item-label">Tanggal Registrasi</div>
                    ...
                    <div class="profile-widget-description">
                      <?= form_open_multipart('pimpinan/pengaturan/akun/ganti_password', ['class' => 'formpassword']) ?>
                        <div class="card-body">
                  ...
                  <div class="card profile-widget">
                    <div class="profile-widget-description">
                      <?= form_open_multipart('pimpinan/pengaturan/akun/edit', ['class' => 'formedit']) ?>
                        <div class="card-body">
  ...
  <script type="text/javascript">
    function data(){
      $.ajax({
          type  : 'POST',
          url   : '<?= site_url()?>pimpinan/pengaturan/akun/profil',
            data:{
                      id : <?= $user['id'] ?>,
                  },
       dataType : 'json',
